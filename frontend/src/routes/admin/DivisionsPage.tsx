        ...
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr className="border-b border-border bg-brand-sky/25 text-left text-xs uppercase tracking-wide text-brand-navy dark:bg-brand-sky/10 dark:text-brand-sky [&>th]:py-1.5 [&>th:first-child]:pl-2 [&>th:last-child]:pr-2">
              <th className="py-2 pr-4 font-semibold">Number</th><th className="pr-4 font-semibold">Name</th><th className="pr-4 font-semibold">Region</th><th className="pr-4 font-semibold">Active</th><th></th>
            </tr>
          </thead>
          <tbody>
            {divisions?.map((d) => (
